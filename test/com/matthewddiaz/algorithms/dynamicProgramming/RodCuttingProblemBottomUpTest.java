 ...
 */
class RodCuttingProblemBottomUpTest {
    ...
    void maxRevenueRodCutBottomUpApproach() {
        ...
        int result1 = RodCuttingProblemBottomUp.maxRevenueRodCutBottomUpApproach(8,prices);

        //9 should be 25
        int expectedResult2 = 25;
        int result2 = RodCuttingProblemBottomUp.maxRevenueRodCutBottomUpApproach(9, prices);
    ...
    void maxRevenueRodCutBottomUpApproachWithSolution() {
        ...
        int result1 = RodCuttingProblemBottomUp.
                maxRevenueCutBottomUpApproachWithSolution(10,prices, maxRevenueTable, solutionsTable);

        RodCuttingProblemBottomUp.printMaxRevenueSolution(9, maxRevenueTable, solutionsTable);
